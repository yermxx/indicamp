...
import Host01 from '@/public/images/mentor_sico.jpg';
import Host03 from '@/public/images/mentor_sunghun.jpg';
            ...
            <div className='lg:flex items-start'>
              ...
              <div className='flex-1 mb-12 lg:mb-0'>
                <div className='mb-6'>
                  ...
                  <div className='text-slate-400 space-y-3 text-lg'>
                    <p>
                      인디캠프에서는 메이저 출신의 기획자와 개발자들이 여러분을
                      가이드하기 위해 대기 중입니다.
                    </p>
                    <p className='italic'>
                      온라인을 통해 질문할 수 있으며, 오프라인에서도 만나실 수
                      있습니다.
                    </p>
                    <p>
                      여러분의 실력을 올려줄 강의와 스터디를 주관하고,
                      프로젝트의 어려운 부분을 함께 해결해 나갈 것입니다.
                    </p>
                  </div>
                </div>
                <div>
                  <Link
                    ...
                    href='/subscribe'
                  >
                    도움 요청하러 가기 <ArrowRight size={20} className='ml-2' />
                  </Link>
                </div>
              </div>
              {/* Right content */}
                ...
                <div className='space-y-12 lg:space-y-20'>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <div className='text-slate-400'>
                        다음커뮤니케이션(현. 카카오)의 개발팀장과 유수의 개발
                        업체에서 CTO를 역임하고 현재는 인디플렉스 대표이사로
                        캠프의 주인장입니다. 마스터 멘토로 여러분의 실력향상과
                        성공적인 프로젝트를 위해 선봉에 섭니다.
                      </div>
                    </div>
                  </div>
                  {/* Host */}
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <div className='text-slate-400'>
                        여러분과 함께 모든 오프라인을 함께할 메인 멘토입니다.
                        오프라인에서 언제나 마나실 수 있습니다. 웹 풀스택
                        개발자입니다.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <div className='text-slate-400'>
                        기획과 디자인 그리고 모바일 앱 개발을 담당하고 있으며,
                        현재 라인(주)에서 안드로이드 개발 리더를 역임하고
                        있습니다. 여러분 프로젝트의 아이데이션부터 기획과 디자인
                        그리고 개발까지 두루 관리해 드립니다.
                      </div>
                    </div>
                  </div>
                </div>
