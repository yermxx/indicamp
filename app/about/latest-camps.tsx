...
import Author01 from '@/public/images/about/author-01.jpg';
import Inspiration01 from '@/public/images/about/inspiration-01.jpg';
import Inspiration02 from '@/public/images/about/inspiration-02.jpg';
import Inspiration03 from '@/public/images/about/inspiration-03.jpg';
import Inspiration04 from '@/public/images/about/inspiration-04.jpg';
import Inspiration05 from '@/public/images/about/inspiration-05.jpg';
import Inspiration06 from '@/public/images/about/inspiration-06.jpg';
          ...
          <div>
            ...
            <div className='mb-8'>
              <div className='flex flex-wrap justify-center md:justify-start -m-1.5'>
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${category === '0' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-200'}`}
                ...
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${category === '1' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-200'}`}
                ...
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${category === '2' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-200'}`}
                ...
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${category === '3' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-200'}`}
                ...
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${category === '4' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-200'}`}
