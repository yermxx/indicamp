import Creative01 from '@/public/images/about/creative-01.jpg';
import Creative02 from '@/public/images/about/creative-02.jpg';
import Creative03 from '@/public/images/about/creative-03.jpg';
import Creative04 from '@/public/images/about/creative-04.jpg';
import CreativeBg01 from '@/public/images/about/creative-bg-01.jpg';
import CreativeBg02 from '@/public/images/about/creative-bg-02.jpg';
import CreativeBg03 from '@/public/images/about/creative-bg-03.jpg';
import CreativeBg04 from '@/public/images/about/creative-bg-04.jpg';
import CreativesImage from '@/public/images/about/creatives.jpg';
        ...
        <div className='py-12 md:py-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            <h2 className='h2 font-cabinet-grotesk'>
              기획자 / 디자이너 / 개발자 누구나 함께하는{' '}
              <strong className='text-blue-500'>인디캠프</strong>
            </h2>
          </div>
          {/* Section content */}
            ...
            <div className='md:w-1/2 md:pl-10 lg:pl-20'>
              <div className='text-center md:text-left'>
                ...
                <p className='text-xl text-gray-500 mb-6'>
                  함께하는 팀 동료 또는 기수 뿐 아니라 모든 인디캠퍼는 연결되어
                  인디캠프와 서울시 새싹(SeSAC) 그리고 서로를 돕습니다.
                </p>
                <SignupCampButton />
              </div>
            </div>
